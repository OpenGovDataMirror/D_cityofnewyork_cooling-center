...
test('extendfeature', () => {
  ...
  expect(center1.get('search_label')).toBe(
    `<b><span class="srch-lbl-lg">${center1.get('FACILITY_NAME')}</span></b><br>` +
...
describe('addressHtml', () => {
  ...
  test('addressHtml', () => {
    ...
    const div = $('<div></div>').html(center1.addressHtml())
...
describe('getHours', () => {
  ...
  test('getHours', () => {
    ...
    // AM/PM
    hours.append(center1.getHours())
    let hrs = hours.children().get(0)
    ...
    expect($(hrs.rows[6].cells[1]).html()).toBe('12:30 PM')
    ...
    //HH24
    global.nycTranslateInstance.trigger('change', {})
    ...
    expect($(hrs.rows[2].cells[0]).html()).toBe('Monday')
    expect($(hrs.rows[2].cells[0]).hasClass('monday')).toBe(true)
    expect($(hrs.rows[2].cells[1]).html()).toBe('18:00')
    expect($(hrs.rows[2].cells[1]).hasClass('op')).toBe(true)
    expect($(hrs.rows[2].cells[2]).html()).toBe('22:00')
    expect($(hrs.rows[2].cells[2]).hasClass('cl')).toBe(true)

    expect($(hrs.rows[3].cells[0]).html()).toBe('Tuesday')
    expect($(hrs.rows[3].cells[0]).hasClass('tuesday')).toBe(true)
    expect($(hrs.rows[3].cells[1]).html()).toBe('18:00')
    expect($(hrs.rows[3].cells[1]).hasClass('op')).toBe(true)
    expect($(hrs.rows[3].cells[2]).html()).toBe('22:00')
    expect($(hrs.rows[3].cells[2]).hasClass('cl')).toBe(true)

    expect($(hrs.rows[4].cells[0]).html()).toBe('Wednesday')
    expect($(hrs.rows[4].cells[0]).hasClass('wednesday')).toBe(true)
    expect($(hrs.rows[4].cells[1]).html()).toBe('18:00')
    expect($(hrs.rows[4].cells[1]).hasClass('op')).toBe(true)
    expect($(hrs.rows[4].cells[2]).html()).toBe('22:00')
    expect($(hrs.rows[4].cells[2]).hasClass('cl')).toBe(true)

    expect($(hrs.rows[5].cells[0]).html()).toBe('Thursday')
    expect($(hrs.rows[5].cells[0]).hasClass('thursday')).toBe(true)
    expect($(hrs.rows[5].cells[1]).html()).toBe('18:00')
    expect($(hrs.rows[5].cells[1]).hasClass('op')).toBe(true)
    expect($(hrs.rows[5].cells[2]).html()).toBe('22:00')
    expect($(hrs.rows[5].cells[2]).hasClass('cl')).toBe(true)

    expect($(hrs.rows[6].cells[0]).html()).toBe('Friday')
    expect($(hrs.rows[6].cells[0]).hasClass('friday')).toBe(true)
    expect($(hrs.rows[6].cells[1]).html()).toBe('12:30')
    expect($(hrs.rows[6].cells[1]).hasClass('op')).toBe(true)
    expect($(hrs.rows[6].cells[2]).html()).toBe('22:00')
    expect($(hrs.rows[6].cells[2]).hasClass('cl')).toBe(true)

    expect($(hrs.rows[7].cells[0]).html()).toBe('Saturday')
    expect($(hrs.rows[7].cells[0]).hasClass('saturday')).toBe(true)
    expect($(hrs.rows[7].cells[1]).html()).toBe('10:00')
    expect($(hrs.rows[7].cells[1]).hasClass('op')).toBe(true)
    expect($(hrs.rows[7].cells[2]).html()).toBe('17:00')
    expect($(hrs.rows[7].cells[2]).hasClass('cl')).toBe(true)
  })
})
...
describe ('detailsHtml', () => {
  ...
  beforeEach(() => {
    global.nycTranslateInstance.messages = {'en': {'pop_type': 'Facility Type', 'pop_address': 'Address', 'pop_phone': 'Phone', 'pop_hours': 'Hours', 'pop_extended': 'Extended Hours', 'pop_access': 'Wheelchair Accessible', 'pop_pet': 'Pet Friendly'}}
  })
  afterEach(() => {
    center1.set('PHONE', '(212)942-2445')
    center1.set('EXTENDED_HOURS', 'No')
  ...
  test('detailsHtml - no exHours', () => {
    expect.assertions(2)

    center1.set('EXTENDED_HOURS', '')
    expect(center1.getStatus()).toBe('OPEN')
    expect(center1.detailsHtml().html()).toBe('<ul><li><b><span class="pop_type">Facility Type</span>: </b><span class="legend_library"></span></li><li><b><span class="pop_address">Address</span>: </b><div class="notranslate">4790 Broadway</div></li><li><b><span class="pop_phone">Phone</span>: </b><div class="notranslate">(212)942-2445</div></li><li><b><span class="pop_hours">Hours</span>: </b><table><thead><tr><th class="day">Day</th><th class="opens">Opens</th><th class="closes">Closes</th></tr></thead><tbody><tr><td class="sunday">Sunday</td><td class="op"><span class="closed">Closed</span></td><td class="cl"><span class="closed">Closed</span></td></tr><tr><td class="monday">Monday</td><td class="op">6:00 PM</td><td class="cl">10:00 PM</td></tr><tr><td class="tuesday">Tuesday</td><td class="op">6:00 PM</td><td class="cl">10:00 PM</td></tr><tr><td class="wednesday">Wednesday</td><td class="op">6:00 PM</td><td class="cl">10:00 PM</td></tr><tr><td class="thursday">Thursday</td><td class="op">6:00 PM</td><td class="cl">10:00 PM</td></tr><tr><td class="friday">Friday</td><td class="op">12:30 PM</td><td class="cl">10:00 PM</td></tr><tr><td class="saturday">Saturday</td><td class="op">10:00 AM</td><td class="cl">5:00 PM</td></tr></tbody></table></li><li><b><span class="pop_access">Wheelchair Accessible</span>: </b><span class="msg-yes"></span></li><li><b><span class=\"pop_pet\">Pet Friendly</span>: </b><span class=\"msg-yes\"></span></li></ul>')
  })
  test('detailsHtml - no access', () => {
    expect.assertions(2)

    center1.set('HANDICAP_ACCESS', '')
    expect(center1.getStatus()).toBe('OPEN')
    expect(center1.detailsHtml().html()).toBe('<ul><li><b><span class="pop_type">Facility Type</span>: </b><span class="legend_library"></span></li><li><b><span class="pop_address">Address</span>: </b><div class="notranslate">4790 Broadway</div></li><li><b><span class="pop_phone">Phone</span>: </b><div class="notranslate">(212)942-2445</div></li><li><b><span class="pop_hours">Hours</span>: </b><table><thead><tr><th class="day">Day</th><th class="opens">Opens</th><th class="closes">Closes</th></tr></thead><tbody><tr><td class="sunday">Sunday</td><td class="op"><span class="closed">Closed</span></td><td class="cl"><span class="closed">Closed</span></td></tr><tr><td class="monday">Monday</td><td class="op">6:00 PM</td><td class="cl">10:00 PM</td></tr><tr><td class="tuesday">Tuesday</td><td class="op">6:00 PM</td><td class="cl\">10:00 PM</td></tr><tr><td class="wednesday">Wednesday</td><td class="op">6:00 PM</td><td class="cl">10:00 PM</td></tr><tr><td class="thursday">Thursday</td><td class="op">6:00 PM</td><td class="cl">10:00 PM</td></tr><tr><td class="friday">Friday</td><td class="op">12:30 PM</td><td class="cl">10:00 PM</td></tr><tr><td class="saturday">Saturday</td><td class="op">10:00 AM</td><td class="cl">5:00 PM</td></tr></tbody></table></li><li><b><span class="pop_extended">Extended Hours</span>: </b><span class="msg-no"></span></li><li><b><span class="pop_access">Wheelchair Accessible</span>: </b><span class="msg-no"></span></li><li><b><span class="pop_pet">Pet Friendly</span>: </b><span class="msg-yes"></span></li></ul>')
  })
})
